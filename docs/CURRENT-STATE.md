...
> `config/cctv_sources.us-dot-live.json` — 149 cameras (91 direct HLS:
...
> 149 count (batch 6: 3 Idaho 511 cameras, suspect per-camera page ids
> replaced with the operator site root). Loaded via the shared `readBundledCameraPack` helper
