...
| **U.S. DOT & federal live-camera pack** (bundled `config/cctv_sources.us-dot-live.json`) | 249 cameras — 106 direct HLS streams (DelDOT ×40, MoDOT, WisDOT, Nevada DOT, Louisiana DOTD), 11 direct still images (ODOT TripCheck + 10 NPS webcams: Rocky Mountain, Olympic, Crater Lake, Big Bend, Grand Canyon, Yellowstone), and 132 page-linked cameras (WSDOT I-5 ×43, USGS volcano webcams ×31 — Hawaiian Volcano Observatory Kīlauea/Mauna Loa + Yellowstone Volcano Observatory, Maryland CHART, 511GA, AZ511, Alaska 511, Idaho 511, DriveNC, and NPS park webcams across 14 parks incl. Acadia, Arches, Zion, Grand Teton, Wrangell-St. Elias, Glacier Bay, and Denali) — with ACCESS LIVE FEED to each operator's own system | Public-courtesy traveler information / NPS + USGS federal content (USGS webcams are U.S. government work, public domain); per-entry provider + attribution note in the pack (ODOT permits public use with credit; Maryland requires acknowledging the State; Yosemite imagery is partner-credited, not presumed public domain) | Panel shows the operator per camera; "State DOT traffic cameras" + NPS/USGS credit lines |
